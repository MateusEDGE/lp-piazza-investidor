# lp-piazza-investidor

Landing page de tráfego pago do Piazza Nicomedes — público investidor.
...
dentro do site, em `nexamalls.com.br/empreendimentos/piazza-nicomedes/investidor`:
